...
class UserAnswersControllerTest < ActionController::TestCase
  ...
  test "should create user_answer" do
    assert_difference('UserAnswer.count') do
      post :create, user_answer: { answer_id: @user_answer.answer_id, correct: @user_answer.correct, points: @user_answer.points, response_id: @user_answer.response_id }
    end
  ...
  test "should update user_answer" do
    patch :update, id: @user_answer, user_answer: { answer_id: @user_answer.answer_id, correct: @user_answer.correct, points: @user_answer.points, response_id: @user_answer.response_id }
    assert_redirected_to user_answer_path(assigns(:user_answer))
  end
