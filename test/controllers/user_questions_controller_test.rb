...
class UserQuestionsControllerTest < ActionController::TestCase
  ...
  test "should create user_question" do
    assert_difference('UserQuestion.count') do
      post :create, user_question: { question_id: @user_question.question_id, relationship: @user_question.relationship, user_id: @user_question.user_id }
    end
  ...
  test "should update user_question" do
    patch :update, id: @user_question, user_question: { question_id: @user_question.question_id, relationship: @user_question.relationship, user_id: @user_question.user_id }
    assert_redirected_to user_question_path(assigns(:user_question))
  end
